...
import com.i.crypto.domain.use_case.get_coin.GetCoinDetailUseCase
...
@HiltViewModel
class CoinDetailViewModel @Inject constructor(private val useCase: GetCoinDetailUseCase, savedStateHandle: SavedStateHandle) : ViewModel() {
